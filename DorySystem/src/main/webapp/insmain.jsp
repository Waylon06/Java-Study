    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item"><a href="./view/insStu-info.html" target="ifm">查询学生信息</a></li>
...
<%--                <li class="layui-nav-item"><a href="view/doryUpdata.html" target="ifm">寝室设置</a></li>--%>
                <li class="layui-nav-item"><a href="./view/insState.html" target="ifm">统计学生未归</a></li>
<%--                <li class="layui-nav-item"><a href="./view/doryDelete.html" target="ifm">删除寝室信息</a></li>--%>
    ...
    <div class="layui-body">
        <!-- 内容主体区域 -->
        <iframe src="./view/insStu-info.html" frameborder="0" name="ifm" class="ifm" style="width:100%;height:100%;"></iframe>
